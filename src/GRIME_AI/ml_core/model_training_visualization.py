...
class ModelTrainingVisualization:
    ...
    def analyze_training_results(
        ...
        report_lines.append(f"  {APP_DISPLAY_NAME} TRAINING DIAGNOSTIC REPORT")
        report_lines.append("=" * 70)
    ...
    def save_training_report(
        ...
        pdf.cell(page_w, 12, _safe(f"{APP_DISPLAY_NAME}  -  Training Diagnostic Report"), border=0, ln=True, align="C", fill=True)
        pdf.set_text_color(0, 0, 0)
        pdf.ln(4)
        ...
        pdf.cell(page_w, 5, _safe(
            f"Generated by {APP_DISPLAY_NAME}  |  {self.formatted_time}  |  Site: {site_name}"
