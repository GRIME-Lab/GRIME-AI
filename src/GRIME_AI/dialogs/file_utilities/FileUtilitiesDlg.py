...
#
# ======================================================================================================================
class FileUtilitiesDlg(QDialog):
    ...
    def pushButton_create_video_clicked(self):
        myApp_video = Video()
        myApp_video.createVideo(self.lineEdit_images_folder.text())

    def pushButtonCreateGIFClicked(self):
        myApp_video = Video()
        myApp_video.createGIF(self.lineEdit_images_folder.text())
...
def getLocalFileDates(filePath, bFetchRecursive):
    ...
    file_count, files = myApp_Utils.getFileList(filePath, extensions, bFetchRecursive)
