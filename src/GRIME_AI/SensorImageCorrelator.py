...
class SensorImageCorrelator:

    def __init__(self, show_gui: bool = False):
        self.className = "SensorImageCorrelator"
...
# ======================================================================================================================
# Command-line use:  python SensorImageCorrelator.py <image_folder> <sensor_csv> [tolerance_minutes]
# ======================================================================================================================
